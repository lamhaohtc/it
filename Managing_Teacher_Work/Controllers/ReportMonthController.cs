...
namespace Managing_Teacher_Work.Controllers
{
    ...
    public class ReportMonthController : BaseController
    {
        ...
        public ActionResult Statistics_Report()
        {
            ...
            string maincnn2 = ConfigurationManager.ConnectionStrings["AppDbContext"].ConnectionString;
            ...
            string maincnn3 = ConfigurationManager.ConnectionStrings["AppDbContext"].ConnectionString;
            ...
            sqlcnn3.Close();
            //--------------------
            string maincnn4 = ConfigurationManager.ConnectionStrings["AppDbContext"].ConnectionString;
            ...
            sqlcnn4.Close();
            //--------------------
            string maincnn5 = ConfigurationManager.ConnectionStrings["AppDbContext"].ConnectionString;
            ...
            sqlcnn5.Close();
            //--------------------
            string maincnn6 = ConfigurationManager.ConnectionStrings["AppDbContext"].ConnectionString;
            ...
            sqlcnn6.Close();
            //--------------------
            string maincnn7 = ConfigurationManager.ConnectionStrings["AppDbContext"].ConnectionString;
            ...
            sqlcnn7.Close();
            //--------------------
            string maincnn8 = ConfigurationManager.ConnectionStrings["AppDbContext"].ConnectionString;
            ...
            sqlcnn8.Close();
            //--------------------
            string maincnn9 = ConfigurationManager.ConnectionStrings["AppDbContext"].ConnectionString;
            ...
            sqlcnn9.Close();
            //--------------------
            string maincnn10 = ConfigurationManager.ConnectionStrings["AppDbContext"].ConnectionString;
            ...
            sqlcnn10.Close();
            //--------------------
            string maincnn11 = ConfigurationManager.ConnectionStrings["AppDbContext"].ConnectionString;
            ...
            sqlcnn11.Close();
            //--------------------
            string maincnn12 = ConfigurationManager.ConnectionStrings["AppDbContext"].ConnectionString;
        ...
        public ActionResult Index()
        {
            ...
            var listClass = db.Class.OrderBy(x => x.ClassCode).ToList();
        ...
        public ActionResult AddFiles(Files model, string submit)
        {
            ...
            else if (submit == "Cập Nhật")
            {
                ...
                SetAlert("Cập nhật mẫu báo cáo thành công!", "success");
                return RedirectToAction("Index");
            }
            else
            {
        ...
        public ActionResult SendReport(ReportMonth model, string submit)
        {
            if (submit == "Gửi")
            {
                ...
                SetAlert("Đã gửi báo cáo tháng thành công!", "success");
                return RedirectToAction("Index");
