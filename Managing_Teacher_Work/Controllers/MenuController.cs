...
namespace Managing_Teacher_Work.Controllers
{
    public class MenuController : BaseController
    {
        ...
        {
            List<Menu> listMenu = _dbContext.Menu.OrderByDescending(x=>x.CreatedDate).ToList();
        ...
        public ActionResult getList(int id)
        {
            ...
            var hs = _dbContext.Menu.SingleOrDefault(x => x.ID == id);
        ...
        public ActionResult Add(Menu model, string submit)
        {
            ...
            else if (submit == "Cập Nhật")
            {
                ...
                if (model != null)
                {
                    var list = _dbContext.Menu.SingleOrDefault(x => x.ID == model.ID);
