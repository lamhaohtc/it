...
namespaces: new[] { "Managing_Teacher_Work.Controllers" }
 ...
 namespaces: new[] { "Managing_Teacher_Work.Controllers" }
  ...
  namespaces: new[] { "Managing_Teacher_Work.Controllers" }
            ...
            routes.MapRoute(
    name: "Chi tiết Tin Tức - Sự Kiện cấp 2",
    ...
    namespaces: new[] { "Managing_Teacher_Work.Controllers" }
            ...
            routes.MapRoute(
       name: "Danh Sách Công Đoàn Viên theo khoa",
       url: "listteacher/{scienseId}",
